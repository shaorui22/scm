 ...
 */
@Slf4j
public class ScmSentinelInvocationHandler implements InvocationHandler {
	...
	ScmSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			ScmSentinelInvocationHandler other = (ScmSentinelInvocationHandler) obj;
