...
package com.kava.scm.common.feign.sentinel.ext;
 ...
 * @date 2020/6/9
 */
public final class ScmSentinelFeign {

	private ScmSentinelFeign() {

	}

	public static ScmSentinelFeign.Builder builder() {
		return new ScmSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public ScmSentinelFeign.Builder contract(Contract contract) {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new ScmSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new ScmSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new ScmSentinelInvocationHandler(target, dispatch);
				}
