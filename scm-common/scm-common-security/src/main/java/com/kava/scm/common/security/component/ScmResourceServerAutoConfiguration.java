...
package com.kava.scm.common.security.component;
...
public class ScmResourceServerAutoConfiguration {
	 ...
	 */
	@Bean
	public ScmBearerTokenExtractor scmBearerTokenExtractor(PermitAllUrlProperties urlProperties) {
		return new ScmBearerTokenExtractor(urlProperties);
	}
	...
	public OpaqueTokenIntrospector opaqueTokenIntrospector(OAuth2AuthorizationService authorizationService) {
		return new ScmCustomOpaqueTokenIntrospector(authorizationService);
	}
