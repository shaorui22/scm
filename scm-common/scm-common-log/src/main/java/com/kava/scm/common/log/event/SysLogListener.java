...
package com.kava.scm.common.log.event;
...
import com.kava.scm.admin.api.feign.RemoteLogService;
import com.kava.scm.common.core.jackson.ScmJavaTimeModule;
import com.kava.scm.common.log.config.ScmLogProperties;
...
public class SysLogListener implements InitializingBean {
	...
	private final ScmLogProperties logProperties;
	...
	public void afterPropertiesSet() {
		...
		objectMapper.registerModule(new ScmJavaTimeModule());
	}
