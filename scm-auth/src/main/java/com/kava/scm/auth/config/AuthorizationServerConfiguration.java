...
package com.kava.scm.auth.config;

import com.kava.scm.auth.support.CustomeOAuth2AccessTokenGenerator;
import com.kava.scm.auth.support.core.CustomeOAuth2TokenCustomizer;
import com.kava.scm.auth.support.core.FormIdentityLoginConfigurer;
import com.kava.scm.auth.support.core.ScmDaoAuthenticationProvider;
import com.kava.scm.auth.support.filter.PasswordDecoderFilter;
import com.kava.scm.auth.support.filter.ValidateCodeFilter;
import com.kava.scm.auth.support.handler.ScmAuthenticationFailureEventHandler;
import com.kava.scm.auth.support.handler.ScmAuthenticationSuccessEventHandler;
import com.kava.scm.auth.support.password.OAuth2ResourceOwnerPasswordAuthenticationConverter;
