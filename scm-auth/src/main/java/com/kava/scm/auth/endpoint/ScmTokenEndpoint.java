...
package com.kava.scm.auth.endpoint;
...
import com.kava.scm.admin.api.entity.SysOauthClientDetails;
import com.kava.scm.admin.api.feign.RemoteClientDetailsService;
import com.kava.scm.admin.api.vo.TokenVo;
import com.kava.scm.auth.support.handler.ScmAuthenticationFailureEventHandler;
...
import com.kava.scm.common.core.util.RetOps;
...
import com.kava.scm.common.security.util.OAuth2ErrorCodesExpand;
import com.kava.scm.common.security.util.OAuthClientException;
...
public class ScmTokenEndpoint {

	private final HttpMessageConverter<OAuth2AccessTokenResponse> accessTokenHttpResponseConverter = new OAuth2AccessTokenResponseHttpMessageConverter();

	private final AuthenticationFailureHandler authenticationFailureHandler = new ScmAuthenticationFailureEventHandler();
	...
	public void checkToken(String token, HttpServletResponse response, HttpServletRequest request) {
		...
		System.out.println("check_token is： " + token);
