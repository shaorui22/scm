/*
 * Copyright (c) 2020 csp4cloud Authors. All Rights Reserved.
 *
...
import com.kava.scm.common.core.servlet.RepeatBodyRequestWrapper;
...
public class PasswordDecoderFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
		...
		System.out.println("PasswordDecoderFilter doFilterInternal .........");
		// 不是登录请求，直接向下执行
