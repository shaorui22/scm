...
public class ScmNacosApplication {

	public static void main(String[] args) {
		if (initEnv()) {
			SpringApplication.run(ScmNacosApplication.class, args);
		}
	}
...
//		MetricsProperties.System.setProperty(ConfigConstants.STANDALONE_MODE, "true");
//		MetricsProperties.System.setProperty(ConfigConstants.AUTH_ENABLED, "true");
